...
function init() {
    console.log("leap motion initialized");
...
function togglePause() {
    ...
    if (paused) {
        ...
        $("#leapmotion-canvas").height(51);
        $("#leapmotion-panel").addClass('hidden');

    } else {
        document.getElementById("pause").innerText = "Stop";
        $("#leapmotion-canvas").height(1500);

        // $("#leapmotion-canvas").attr("style", "width: 700px;");
        $("#leapmotion-panel").removeClass('hidden');
